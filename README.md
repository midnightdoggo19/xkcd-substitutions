...
Just create a new bookmark with the name “XKCD Substitutions” and with the code below as the URL:
    ...
    javascript:var s = document.createElement('script');s.type='text/javascript';document.body.appendChild(s);s.src='https://github.com/midnightdoggo19/xkcd-substitutions/releases/latest/download/substitutions.js';void(0);
